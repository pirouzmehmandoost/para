...
export default function Projects() {
    return (
        <div className="flex flex-col w-screen h-full mt-14 uppercase text-neutral-600">
            ...
            <div className="absolute top-20 left-10 mt-10 p-2 rounded-full bg-neutral-200 transition-colors duration-200 ease-in-out hover:text-neutral-500" >  
                <Link
                    href="/"
                    rel="noopener noreferrer"
                >
                    <div className="flex flex-row w-full place-items-center cursor-pointer text-4xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-5xl">
                        <ArrowBackIosNewIcon/>
                    </div>
                </Link>
            </div>
