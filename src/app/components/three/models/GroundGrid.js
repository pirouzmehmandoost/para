...
// import useMaterial, { groundGridMeshPhysicalMaterialConfig } from '@stores/materialStore';
...
//   const materialRef = useRef(new THREE.MeshPhysicalMaterial({ ...groundGridMeshPhysicalMaterialConfig }));
