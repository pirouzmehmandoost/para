            ...
            {projects.map((data, index) => {
              ...
              return (
                <group
                  ...
                  onPointerOut={(e) => {
                    //only invoke event handler on desktop.
                    if (e.pointerType === "mouse") {
                      if (!currentSelection) {
                        setPointerTarget({});
                      }
                  ...
                  <Group {...newProps.sceneData}>
                    <Html
                      position={[
                        ...
                        groupPositions[index].y + 70,
                        groupPositions[index].z,
                      ]}
                    >
                      <span
                        className={`cursor-pointer uppercase text-nowrap w-fit h-96 text-center text-clay_dark text-5xl transition-opacity duration-500 ease-in-out ${!!currentSelection && pointerTarget?.eventObject === currentSelection.name ? "opacity-100 transition-colors  duration-500 ease-in-out hover:text-slate-500 " : "opacity-0"}`}
                        onClick={(e) => {
                          //   console.log(
                          //     "clicked on text. currentSelection: ",
                          //     currentSelection,
                          //     "state selection:",
                          //     s,
                          //     "evennt: ",
